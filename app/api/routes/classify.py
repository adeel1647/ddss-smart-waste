...
from app.schemas.classify import ClassifyResponse, ImageExplainabilityOut, TopKItem
...
async def classify_image(
    ...
    best, top, explainability = service.predict_with_explainability(image, top_k=settings.top_k)
    ...
    return ClassifyResponse(
        ...
        stored=stored,
        image_explainability=ImageExplainabilityOut(
            overlay_image_base64=explainability.overlay_image_base64,
            heatmap_image_base64=explainability.heatmap_image_base64,
            explanation=explainability.explanation,
            last_conv_layer=explainability.last_conv_layer,
        ),
    )